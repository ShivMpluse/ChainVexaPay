    ...
    return (
        <div className='flex flex-col justify-center items-center px-4 w-full md:w-3/4 text-justify mt-10 md:mt-20 mx-auto gap-6'>
            <motion.h1 
                ...
                delay={0.2}
                className='text-3xl md:text-5xl font-bold mb-2 text-white capitalize leading-snug text-center py-2 '>
                {tittle}
            </motion.h1>
            ...
            <motion.p 
                ...
                transition={{ duration: 0.8, ease: 'easeOut' }}
                delay={0.2}
                className='text-base md:text-lg mb-4 text-gray-300 w-full text-center'>
                {subTittle}
            </motion.p>
